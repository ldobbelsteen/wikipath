...
func redirDumpParse(path string, titler map[PageTitle]PageID) (<-chan Redir, error) {
...
func linkDumpParse(path string, titler map[PageTitle]PageID, redirects map[PageID]PageID) (<-chan Link, func(), error) {
